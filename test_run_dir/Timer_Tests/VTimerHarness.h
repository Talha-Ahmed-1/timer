...
VL_MODULE(VTimerHarness) {
  public:
    ...
    VL_SIG8(TimerHarness__DOT__timer__DOT__io_rsp_bits_error_REG_2,0,0);
    ...
    VL_SIG(TimerHarness__DOT__timer__DOT__TimerReg,31,0);
    VL_SIG(TimerHarness__DOT__timer__DOT__ControlReg,31,0);
    VL_SIG(TimerHarness__DOT__timer__DOT__CompareReg,31,0);
    VL_SIG(TimerHarness__DOT__timer__DOT__PreCountReg,31,0);
    VL_SIG(TimerHarness__DOT__timer__DOT__io_rsp_bits_dataResponse_REG,31,0);
    ...
    VL_SIG(TimerHarness__DOT__timer__DOT__io_rsp_bits_dataResponse_REG_6,31,0);
    VL_SIG(TimerHarness__DOT__timer__DOT___GEN_4,31,0);
    VL_SIG(TimerHarness__DOT__timer__DOT___PreCountReg_T_1,31,0);
    VL_SIG(TimerHarness__DOT__timer__DOT___TimerReg_T_1,31,0);
    
    // LOCAL VARIABLES
    // Internals; generally not touched by application code
    VL_SIG8(__Vclklast__TOP__clock,0,0);
    //char	__VpadToAlign137[3];
  ...
  public:
    static void	_combo__TOP__3(VTimerHarness__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void	_sequent__TOP__1(VTimerHarness__Syms* __restrict vlSymsp);
    static void	_sequent__TOP__4(VTimerHarness__Syms* __restrict vlSymsp);
    static void	_sequent__TOP__6(VTimerHarness__Syms* __restrict vlSymsp);
    static void	_settle__TOP__2(VTimerHarness__Syms* __restrict vlSymsp);
    static void	_settle__TOP__5(VTimerHarness__Syms* __restrict vlSymsp);
