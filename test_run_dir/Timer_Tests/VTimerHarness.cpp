...
VL_INLINE_OPT void VTimerHarness::_sequent__TOP__1(VTimerHarness__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    VTimerHarness::_sequent__TOP__1\n"); );
    VTimerHarness* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    VL_SIG8(__Vdly__TimerHarness__DOT__hostAdapter__DOT__stateReg,0,0);
    //char	__VpadToAlign5[3];
    VL_SIG(__Vdly__TimerHarness__DOT__timer__DOT__TimerReg,31,0);
    VL_SIG(__Vdly__TimerHarness__DOT__timer__DOT__PreCountReg,31,0);
    // Body
    __Vdly__TimerHarness__DOT__hostAdapter__DOT__stateReg 
	= vlTOPp->TimerHarness__DOT__hostAdapter__DOT__stateReg;
    __Vdly__TimerHarness__DOT__timer__DOT__PreCountReg 
	= vlTOPp->TimerHarness__DOT__timer__DOT__PreCountReg;
    __Vdly__TimerHarness__DOT__timer__DOT__TimerReg 
    ...
    // ALWAYS at TimerHarness.v:411
    vlTOPp->TimerHarness__DOT__timer__DOT__io_rsp_bits_error_REG_2 
	= ((IData)(vlTOPp->TimerHarness__DOT__deviceAdapter_io_reqOut_valid) 
	   & (~ ((((0U == (0xfU & vlTOPp->TimerHarness__DOT__hostAdapter_io_wbMasterTransmitter_bits_adr)) 
		 ...
		 | (0xcU == (0xfU & vlTOPp->TimerHarness__DOT__hostAdapter_io_wbMasterTransmitter_bits_adr)))));
    // ALWAYS at TimerHarness.v:397
			...
			& (IData)(vlTOPp->TimerHarness__DOT__hostAdapter_io_wbMasterTransmitter_bits_we))
				...
				& (IData)(vlTOPp->TimerHarness__DOT__hostAdapter_io_wbMasterTransmitter_bits_we))
					...
					& (~ (IData)(vlTOPp->TimerHarness__DOT__hostAdapter_io_wbMasterTransmitter_bits_we)))
				        ...
				        : vlTOPp->TimerHarness__DOT__timer__DOT__io_rsp_bits_dataResponse_REG_6))))));
	} else {
    ...
    // ALWAYS at TimerHarness.v:398
    vlTOPp->TimerHarness__DOT__timer__DOT__io_rsp_bits_dataResponse_REG_1 
	= vlTOPp->TimerHarness__DOT__hostAdapter_io_wbMasterTransmitter_bits_dat;
    // ALWAYS at TimerHarness.v:408
    vlTOPp->TimerHarness__DOT__timer__DOT__io_rsp_bits_dataResponse_REG_6 
	= vlTOPp->TimerHarness__DOT__hostAdapter_io_wbMasterTransmitter_bits_adr;
    // ALWAYS at TimerHarness.v:404
    vlTOPp->TimerHarness__DOT__timer__DOT__io_rsp_bits_dataResponse_REG_4 
	= vlTOPp->TimerHarness__DOT__timer__DOT__CompareReg;
    // ALWAYS at TimerHarness.v:400
    vlTOPp->TimerHarness__DOT__timer__DOT__io_rsp_bits_dataResponse_REG_2 
	= vlTOPp->TimerHarness__DOT__timer__DOT__ControlReg;
    // ALWAYS at TimerHarness.v:358
    if (vlTOPp->reset) {
	__Vdly__TimerHarness__DOT__timer__DOT__TimerReg = 0U;
    } else {
	if ((1U & (~ ((0U == vlTOPp->TimerHarness__DOT__timer__DOT__PreCountReg) 
		      & vlTOPp->TimerHarness__DOT__timer__DOT__ControlReg)))) {
	    if ((vlTOPp->TimerHarness__DOT__timer__DOT__TimerReg 
		 == vlTOPp->TimerHarness__DOT__timer__DOT__CompareReg)) {
		__Vdly__TimerHarness__DOT__timer__DOT__TimerReg = 0U;
	    } else {
		if ((vlTOPp->TimerHarness__DOT__timer__DOT__PreCountReg 
		     == (0x7fffffffU & (vlTOPp->TimerHarness__DOT__timer__DOT__ControlReg 
					>> 1U)))) {
		    __Vdly__TimerHarness__DOT__timer__DOT__TimerReg 
			= vlTOPp->TimerHarness__DOT__timer__DOT___TimerReg_T_1;
		}
	    }
	}
    }
    if (vlTOPp->reset) {
	__Vdly__TimerHarness__DOT__timer__DOT__PreCountReg = 0U;
    } else {
	if (((0U == vlTOPp->TimerHarness__DOT__timer__DOT__PreCountReg) 
	     & vlTOPp->TimerHarness__DOT__timer__DOT__ControlReg)) {
	    __Vdly__TimerHarness__DOT__timer__DOT__PreCountReg 
		= vlTOPp->TimerHarness__DOT__timer__DOT___PreCountReg_T_1;
	} else {
	    if ((vlTOPp->TimerHarness__DOT__timer__DOT__TimerReg 
		 != vlTOPp->TimerHarness__DOT__timer__DOT__CompareReg)) {
		__Vdly__TimerHarness__DOT__timer__DOT__PreCountReg 
			...
			== (0x7fffffffU & (vlTOPp->TimerHarness__DOT__timer__DOT__ControlReg 
					   >> 1U)))
		        ? 0U : vlTOPp->TimerHarness__DOT__timer__DOT___PreCountReg_T_1);
	    }
	}
    }
    vlTOPp->TimerHarness__DOT__timer__DOT__io_rsp_bits_dataResponse_REG 
    ...
    vlTOPp->TimerHarness__DOT__timer__DOT___PreCountReg_T_1 
	= ((IData)(1U) + vlTOPp->TimerHarness__DOT__timer__DOT__PreCountReg);
    vlTOPp->TimerHarness__DOT__timer__DOT___TimerReg_T_1 
	= ((IData)(1U) + vlTOPp->TimerHarness__DOT__timer__DOT__TimerReg);
    // ALWAYS at TimerHarness.v:376
    if (vlTOPp->reset) {
	...
	if ((1U & (~ ((0U == (0xfU & vlTOPp->TimerHarness__DOT__hostAdapter_io_wbMasterTransmitter_bits_adr)) 
		...
		if ((1U & (~ ((4U == (0xfU & vlTOPp->TimerHarness__DOT__hostAdapter_io_wbMasterTransmitter_bits_adr)) 
			      & (~ (IData)(vlTOPp->TimerHarness__DOT__hostAdapter_io_wbMasterTransmitter_bits_we)))))) {
		    vlTOPp->TimerHarness__DOT__timer__DOT__CompareReg 
			= vlTOPp->TimerHarness__DOT__timer__DOT___GEN_4;
		}
	    }
	}
    }
    // ALWAYS at TimerHarness.v:367
    if (vlTOPp->reset) {
	...
	= ((IData)(vlTOPp->TimerHarness__DOT__hostAdapter__DOT__startWBTransaction)
	    ? vlTOPp->TimerHarness__DOT__hostAdapter__DOT__adrReg
	    : 0U);
    vlTOPp->io_intr_ovf = (vlTOPp->TimerHarness__DOT__timer__DOT__ControlReg 
			   & (0xffffffffU == vlTOPp->TimerHarness__DOT__timer__DOT__TimerReg));
    vlTOPp->io_intr_cmp = (vlTOPp->TimerHarness__DOT__timer__DOT__ControlReg 
			   & (vlTOPp->TimerHarness__DOT__timer__DOT__TimerReg 
			      == vlTOPp->TimerHarness__DOT__timer__DOT__CompareReg));
}

void VTimerHarness::_settle__TOP__2(VTimerHarness__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    VTimerHarness::_settle__TOP__2\n"); );
    VTimerHarness* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->io_rsp_bits_error = vlTOPp->TimerHarness__DOT__hostAdapter__DOT__errReg;
    vlTOPp->io_rsp_valid = vlTOPp->TimerHarness__DOT__hostAdapter__DOT__respReg;
	...
	= (((0U == (0xfU & vlTOPp->TimerHarness__DOT__hostAdapter_io_wbMasterTransmitter_bits_adr)) 
		...
		& (IData)(vlTOPp->TimerHarness__DOT__hostAdapter_io_wbMasterTransmitter_bits_we))
	        ? (IData)(vlTOPp->TimerHarness__DOT__timer__DOT__io_rsp_valid_REG)
	        : (IData)(vlTOPp->TimerHarness__DOT__timer__DOT__io_rsp_bits_error_REG_2)));
}

VL_INLINE_OPT void VTimerHarness::_combo__TOP__3(VTimerHarness__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    VTimerHarness::_combo__TOP__3\n"); );
    VTimerHarness* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->TimerHarness__DOT__hostAdapter__DOT___GEN_1 
	= ((IData)(vlTOPp->TimerHarness__DOT__hostAdapter__DOT__stateReg) 
...
VL_INLINE_OPT void VTimerHarness::_sequent__TOP__4(VTimerHarness__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    VTimerHarness::_sequent__TOP__4\n"); );
    VTimerHarness* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->TimerHarness__DOT__deviceAdapter_io_reqOut_valid 
	= (((IData)(vlTOPp->TimerHarness__DOT__hostAdapter_io_wbMasterTransmitter_bits_stb) 
...
void VTimerHarness::_settle__TOP__5(VTimerHarness__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    VTimerHarness::_settle__TOP__5\n"); );
    VTimerHarness* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->TimerHarness__DOT__timer__DOT___GEN_4 = 
	(((8U == (0xfU & vlTOPp->TimerHarness__DOT__hostAdapter_io_wbMasterTransmitter_bits_adr)) 
...
VL_INLINE_OPT void VTimerHarness::_sequent__TOP__6(VTimerHarness__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    VTimerHarness::_sequent__TOP__6\n"); );
    VTimerHarness* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->TimerHarness__DOT__hostAdapter__DOT___GEN_24 
	= (((IData)(vlTOPp->TimerHarness__DOT__deviceAdapter_io_wbSlaveTransmitter_bits_err) 
...
void VTimerHarness::_ctor_var_reset() {
    ...
    TimerHarness__DOT__timer__DOT__TimerReg = VL_RAND_RESET_I(32);
    TimerHarness__DOT__timer__DOT__ControlReg = VL_RAND_RESET_I(32);
    TimerHarness__DOT__timer__DOT__CompareReg = VL_RAND_RESET_I(32);
    TimerHarness__DOT__timer__DOT__PreCountReg = VL_RAND_RESET_I(32);
    TimerHarness__DOT__timer__DOT__io_rsp_bits_dataResponse_REG = VL_RAND_RESET_I(32);
    ...
    TimerHarness__DOT__timer__DOT__io_rsp_bits_dataResponse_REG_6 = VL_RAND_RESET_I(32);
    TimerHarness__DOT__timer__DOT___GEN_4 = VL_RAND_RESET_I(32);
    TimerHarness__DOT__timer__DOT___PreCountReg_T_1 = VL_RAND_RESET_I(32);
    TimerHarness__DOT__timer__DOT___TimerReg_T_1 = VL_RAND_RESET_I(32);
    TimerHarness__DOT__timer__DOT__io_rsp_bits_error_REG_2 = VL_RAND_RESET_I(1);
